  ...
  const adminSections = [
    ...
    },
    {
      ...
      cards: [
        ...
        {
          path: "/admin/playground-management",
          icon: "icon-app",
          label: t("managePg"),
          color: "#11cdef",
          roles: ["LEADER", "ASSISTANT", "ADMIN"],
        },
        {
          ...
          label: t("matchManagement") || "Správa zápasů",
          color: "#8965e0",
          roles: ["LEADER", "ASSISTANT", "ADMIN"],
        },
      ],
    },
    {
      ...
      cards: [
        {
          path: "/admin/tournament-generator",
          icon: "icon-trophy",
          label: t("tournamentGenerator") || "Generování turnaje",
          color: "#fc5603",
          description:
            t("tournamentGeneratorDesc") ||
            "Generování skupin a pavouka pro turnajové disciplíny",
          roles: ["LEADER", "ADMIN"],
        },
        {
    ...
    <div className="content">
      {filteredAdminSections.map((section, sectionIdx) => (
        <div key={sectionIdx} className="mb-5">
          <h4
            className={`mb-4 ${isDark ? "text-white" : "text-dark"}`}
            style={{
